...
def Download_Event():
    ...
    label = ttk.Label(root, text="Patients, The Video is Downloading...",foreground="#ff8000")
...
try:
    root.tk.call("source", r"E:\Codeing\Python Language\Projects\Project_22_4K_Videos\Theme\azure.tcl")  # Replace with the correct path to azure.tcl
