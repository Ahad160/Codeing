...
pin_path = f"{drive_letters[1]}\Database_Pincode.txt"
pin_path_2 = f"{drive_letters[1]}\Pincode_encryption_key.key"
...
if os.path.exists(file_path):
    ...
    # Encryption-----Auto
    # 🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒 Encryption
    Encryption_M.Encryption(file_path_2,file_path)

    pin=int(input("Enter Pin code For Password Manager-"))
    with open(pin_path, 'w') as file:
        file.write(str(pin))

    # 🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒🔒 Encryption
    Encryption_M.Encryption(pin_path_2,pin_path)
    exit()
...
#Lock Protection
lock_system_M.lock_Protect(pin_path_2,pin_path)
