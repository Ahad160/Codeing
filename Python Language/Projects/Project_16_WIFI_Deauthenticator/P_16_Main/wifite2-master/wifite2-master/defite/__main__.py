...
try:
    ...
    raise Exception("You may need to run defite from the root directory (which includes README.md)", e) from e
...
class defite(object):
    ...
    def print_banner():
        ...
        Color.pl(r'          **  ***          ***  **             ')
        Color.pl(r'         **  **   *{BR}|    |{BR}{GR}*   **  **            ')
        Color.pl(r'        **  **  ***  **  ***  **  **     {W}defite2 {G}%s{GR}' % Configuration.version )
        Color.pl(r'        **  *   **  {BR}|--|{BR}{GR}  **  **  **     {W}Wifi Deauthentication Tool{GR}')
        Color.pl(r'        **  **  **  {BR}|--|{BR}{GR}  **  **  **     {W}Modified by {C}Raiden{GR}')
        Color.pl(r'        **  **   **  **   **  **  **           ')
