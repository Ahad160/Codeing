...
python3 defite.py --skip-crack --reaver -2 --showm --showb --kill --wpat 160 --pmkid-timeout 100 --wps-time 120 --no-nullpin --wps --power 28 -p 100 -inf --wps-timeout 50 --wps-fails 10 -ic
